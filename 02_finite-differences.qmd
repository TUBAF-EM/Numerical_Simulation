...
![Simple 2D conductivity grid with FD stencil](pics/fd/grid32sigmaStencil.svg){#fig-2dfd-stencil}
...
![Forward difference stencil](pics/fd/dtforward.svg)

### Implicit (Euler) method

$$ \pdv{T}{t}^n \approx \frac{T^{n+1}-T^n}{\Delta t} = a \pdv[2]{T}{z} ^{n+1} $$

![Forward difference stencil](pics/fd/dtbackward.svg)
